...
use crate::{
    burn_tokens, calculate_health_factor, get_lamports_from_usd, withdraw_sol, Collateral, Config,
    CustomError, SEED_CONFIG_ACCOUNT,
};
...
pub fn process_liquidate(ctx: Context<Liquidate>, amount_to_burn: u64) -> Result<()> {
    ...
    withdraw_sol(
        ...
        &ctx.accounts.collateral_account.depostior,
